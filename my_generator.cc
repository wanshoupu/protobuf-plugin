...
namespace my {
    ...
    void MyGenerator::PrintImports() const {
    ...
    void MyGenerator::PrintFileDescriptor() const {
      map<string, string> m;
    ...
    void MyGenerator::PrintAllNestedEnumsInFile() const {
    ...
    void MyGenerator::PrintTopLevelExtensions() const {
    ...
    void MyGenerator::PrintMessageDescriptors() const {
      for (int i = 0; i < file_->message_type_count(); ++i) {
    ...
    void MyGenerator::PrintFieldsInDescriptor(
    ...
    void MyGenerator::PrintExtensionsInDescriptor(
        const Descriptor& message_descriptor) const {
      const bool is_extension = true;
      PrintFieldDescriptorsInDescriptor(
